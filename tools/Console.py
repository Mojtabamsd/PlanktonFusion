...
class Console:
    ...
    def banner():
        ...
        print(" This is free software, you can redistribute it ")
        print(" and/or modify it under the terms of the GNU    ")
        print(" General Public License as published by the Free")
        print(" Software Foundation version 3.0.")
        print(" ")
    ...
    @staticmethod
    def get_version(pkg_name="georef_semantics"):
